  ...
  async up (queryInterface, Sequelize) {
   await queryInterface.bulkInsert('item_features', [
    ...
    },
    {
      ...
      description: "Двухкамерный теплопакет класса 4+ к каждому окну в подарок.",
      item_id: 1,
      createdAt: new Date(),
      updatedAt: new Date(),
    },
    {
      ...
      description: "Эконом класса имеет широкую облась применения для любых типов домов.",
      item_id: 1,
      createdAt: new Date(),
      updatedAt: new Date(),
    },
    {
      ...
      description: "Обеспечивает защиту от проникновения влаги и пыли в помещение, доступен в трех вариантах цвета: черном, светло-сером и белом.",
      item_id: 1,
      createdAt: new Date(),
      updatedAt: new Date(),
    },
